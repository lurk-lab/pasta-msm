...
extern "C" RustError cuda_pippenger_vesta(point_t *out, const affine_t points[], 
                                          size_t npoints, size_t nnz, const scalar_t scalars[])
{
    return mult_pippenger<bucket_t>(out, points, npoints, nnz, scalars);
}

extern "C" RustError cuda_pippenger_vesta_with(point_t *out, msm_context_t<affine_t::mem_t> *msm_context, 
                                                size_t npoints, size_t nnz, scalar_t scalars[])
{
